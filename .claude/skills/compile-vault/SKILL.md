---
name: compile-vault
description: Implement or improve the compiler that turns raw sources into a linked Markdown vault.
...
Implement or improve the compiler that turns raw sources into a linked Markdown vault.
