---
name: wire-deerflow
description: Add or revise a DeerFlow adapter without leaking orchestration assumptions into the core domain.
...
Add or revise a DeerFlow adapter without leaking orchestration assumptions into the core domain.
